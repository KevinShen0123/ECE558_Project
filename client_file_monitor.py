...
def handle_change(changes):
    ...
    for change in changes:
        ...
        if action == "removed":
            send_delete_file_request(file_path) # send delete request
            return
        else:
            ...
            if file_size > max_size:
                send_chunked_data_over_existing_connection(file_path)
            else:
                send_data_over_existing_connection(file_path)
